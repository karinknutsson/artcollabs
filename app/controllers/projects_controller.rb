class ProjectsController < ApplicationController
  ...
  def add_milestone
    @first_milestone = Milestone.new(title: "Project created", 
                                    description: "The project #{@project.title} 
                                    was created on #{Date.today} by #{@project.user.username}", completed: true)
